...
public class FrameAdd extends JFrame {
    ...
    public FrameAdd (FrameMain a, Actor x){
        createGUI(a, x);
    }

    private void createGUI(FrameMain a, Actor x) {
        this.setLayout(null);
        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(t1.getText().equals("")==false && t2.getText().equals("")==false && t3.getText().equals("")==false && t4.getText().equals("")==false && t5.getText().equals("")==false) {
                    x.setName(t1.getText());
                    x.setExperience(Integer.parseInt(t2.getText()));
                    x.setSalary(Integer.parseInt(t3.getText()));
                    x.setNumber_of_roles(Integer.parseInt(t4.getText()));
                    x.setType(t5.getText());
                    setVisible(false);
                    a.setVisible(true);
                    dispose();
                }
