...
bool cmpJob1(Emploee&, Emploee&);
bool cmpWages1(Emploee&, Emploee&);
bool cmpSeniority1(Emploee&, Emploee&);
bool cmpName1(Emploee&, Emploee&);
bool cmpHomeNum1(Emploee&, Emploee&);
bool cmpPostNum1(Emploee&, Emploee&);
//-------------------------------------------------------------------------------
class Organization
{
private:
